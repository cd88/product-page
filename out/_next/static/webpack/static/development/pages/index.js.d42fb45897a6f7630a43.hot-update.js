...
function (_React$Component) {
  ...
  _createClass(NumberPicker, [{
    ...
    value: function handleChange(event) {
      var val = event.target.value <= 0 ? 1 : event.target.value >= 21 ? 20 : event.target.value;
      this.setState({
        value: val
      });
      this.props.updateQuantity(val);
    }
  }, {
    key: "render",
...
NumberPicker.propTypes = {
  updateQuantity: prop_types__WEBPACK_IMPORTED_MODULE_2___default.a.func
};
...
//# sourceMappingURL=index.js.d42fb45897a6f7630a43.hot-update.js.map