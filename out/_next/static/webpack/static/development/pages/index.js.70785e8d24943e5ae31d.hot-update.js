...
function (_React$Component) {
  ...
  _createClass(NumberPicker, [{
    ...
    value: function handleChange(event) {
      ...
      var newVal = event.target.value <= 0 ? 1 : event.target.value >= 21 && event.target.value <= 24 ? val == 20 ? 25 : 20 : event.target.value >= 26 && event.target.value <= 29 ? val == 25 ? 30 : 25 : event.target.value >= 31 && event.target.value <= 34 ? val == 30 ? 35 : 30 : event.target.value >= 36 && event.target.value <= 39 ? val == 35 ? 40 : 35 : event.target.value >= 41 ? 40 : event.target.value;
      this.setState({
        value: val
      });
...
//# sourceMappingURL=index.js.70785e8d24943e5ae31d.hot-update.js.map