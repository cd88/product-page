...
function (_React$Component) {
  ...
  _createClass(NumberPicker, [{
    ...
    value: function handleChange(event) {
      ...
      var newVal = event.target.value <= 0 ? 1 : event.target.value > 20 && event.target.value < 25 ? val === 20 ? 25 : 20 : event.target.value > 25 && event.target.value < 30 ? val === 25 ? 30 : 25 : event.target.value > 30 && event.target.value < 35 ? val === 30 ? 35 : 30 : event.target.value > 35 && event.target.value < 40 ? val === 35 ? 40 : 35 : event.target.value > 40 ? 40 : event.target.value;
      this.setState({
        value: newVal
      });
...
//# sourceMappingURL=index.js.3cf50ad99ed550fddbdc.hot-update.js.map