...
function (_React$Component) {
  ...
  _createClass(NumberPicker, [{
    ...
    value: function handleChange(event) {
      ...
      var newVal = event.target.value <= 0 ? 1 : event.target.value > 20 && event.target.value <= 24 ? val === 20 ? 25 : 20 : event.target.value > 25 && event.target.value <= 29 ? val === 25 ? 30 : 25 : event.target.value > 30 && event.target.value <= 34 ? val === 30 ? 35 : 30 : event.target.value > 35 && event.target.value <= 39 ? val === 35 ? 40 : 35 : event.target.value > 40 ? 40 : event.target.value;
      this.setState({
        value: newVal
      });
...
//# sourceMappingURL=index.js.b51f68c45c3c05eeb979.hot-update.js.map